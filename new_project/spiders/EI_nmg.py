...
class EIOffice(object):
    ...
    def __init__(self, journal, start_year, _search_type, search_id):
        ...
        self.referer = "http://nmg.ilibs.cn/rwt/45/https/P75YPLUFN3UXT5UFMW3GT5UHP3VXZ5DBM7TT6Z5QNF/search/quick.url"
        self.host_url = "http://nmg.ilibs.cn/rwt/45/https/P75YPLUFN3UXT5UFMW3GT5UHP3VXZ5DBM7TT6Z5QNF/"
        self.headers = headersChange(f'''accept: application/json, text/javascript, */*; q=0.01
accept-encoding: gzip, deflate, br
accept-language: zh-CN,zh;q=0.9
cache-control: no-cache
content-type: application/x-www-form-urlencoded
origin: http://nmg.ilibs.cn
pragma: no-cache
